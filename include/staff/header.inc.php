...
<div id="container">
    ...
    <!-- For testing  -->
    <p>Elshuye @staff/header.inc.php</p>
<?php } else {
...
<?php include STAFFINC_DIR . "templates/navigation.tmpl.php"; ?>
    ...
    <!-- for testing -->
   <p>Ethiopia @staff/header.inc.php</p>
        <div id="content">
...
<?php   } ?>
<?php
echo"<button onclick=alert('yyyyyyyyy') style='margin: 10px; padding: 5px;color:blue;'>Click me(@staff/header.inc.php</button>"
